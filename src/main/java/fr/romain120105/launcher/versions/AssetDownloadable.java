...
public class AssetDownloadable extends DownloadEntry
{
    ...
    public AssetDownloadable(final String name, final AssetIndex.AssetObject asset, final String url, final File destination, final Launcher launcher) throws MalformedURLException {
        super(new URL(String.valueOf(url) + createPathFromHash(asset.getHash())), null, null, launcher);
        this.asset = asset;
