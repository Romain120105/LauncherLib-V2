...
public class DownloadEntry
{
    ...
    public DownloadEntry(final URL url, final File destination, final String sha1, final Launcher launcher) {
        this.url = url;
    ...
    public boolean needDownload() {
        ...
        if (!this.destination.getParentFile().getAbsolutePath().equals(this.launcher.getMinecraftFolder().getNativesFolder().getAbsolutePath())) {
